...
public class ModuleFeaturesTest extends BaseTest
{
     ReadConfigFile config;
     
	public ModuleFeaturesTest() throws IOException
	{
		super();
	}
...
//		       Thread.sleep(6000);
		       ...
		       Thread.sleep(3000);
		       featuremodule.addnameFiled("Client Users");
		       Thread.sleep(3000);
		       featuremodule.adddescriptionFiled("Client Users");
...
//		       Thread.sleep(3000);
		       ...
		       Thread.sleep(3000);
		       featuremodule.addpageFileName("/user-module/client-users");
		       Thread.sleep(3000);
