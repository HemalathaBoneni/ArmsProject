...
public class ModuleFeaturesPage11 
{
 public WebDriver driver;
	Actions action;
	
	public ModuleFeaturesPage11(WebDriver driver)
	{
		this.driver=driver;
		PageFactory.initElements(driver, this);
	}
	
	@FindBy(xpath="//a[normalize-space()='Module Feature']")
	WebElement modulefeature;
	
	@FindBy(xpath="//select[@id='module']/option[text()='ARMS']")
	WebElement modules;
...
//	WebElement pagefile;
	...
	@FindBy(xpath="//select[@id='parentAmfId']/option[text()='User Management']")
